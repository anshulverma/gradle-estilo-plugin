...
To be able to use checkstyle version `6.12.1` you need to use gradle version `2.7` or above. This is
caused because of issue: [checkstyle #1108](https://github.com/checkstyle/checkstyle/issues/1108).
